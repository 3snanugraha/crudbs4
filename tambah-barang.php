    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Tambahkan Data barang. <b><a href="data-barang.php">Lihat data barang</a></b></p>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Tambahkan Data Barang</h6>
            </div>
            <div class="card-body">
            <form action="proses-tambah-barang.php" method="POST">
                ...
                <input type="file" class="form-control-file" id="foto" placeholder="Foto" name="foto">
                </div>
